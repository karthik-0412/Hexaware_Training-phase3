...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DepositeAmountShouldbeMoreException.class)
    public ResponseEntity<ApiError> handleamount(
            DepositeAmountShouldbeMoreException ex, HttpServletRequest req) {
        return buildError(ex, req, HttpStatus.NOT_ACCEPTABLE);
    }
